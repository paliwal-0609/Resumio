            ...
            <div className='grid lg:grid-cols-12 gap-8'>
                ...
                <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
                    ...
                    <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
                        ...
                        <hr className='absolute top-0 left-0 h-1 bg-linear-to-r from-yellow-300 to-red-500 border-none transition-all duration-2000' style={{width: `${activeSectionIndex * 100 / (sections.length -1)}%`}}/>
                ...
                <div className='lg:col-span-7 max-lg:mt-6'>
                    <div className='relative w-full'>
                        ...
                        <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                            ...
                            <button onClick={downloadResume} className='flex items-center gap-2 px-6 py-2 text-xs bg-linear-to-br from-red-100 to-yellow-100 text-red-500 rounded-lg ring-red-300 hover:ring transition-colors'>
