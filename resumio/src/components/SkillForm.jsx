  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='bg-blue-50 p-3 rounded-lg'>
            <p className='text-sm text-blue-800'><strong>Tip:</strong>Add 5-8 relevant skills. Include both technical skills(programming languages, tools etc.) and soft skills(leadership, communication etc.)</p>
        </div>
