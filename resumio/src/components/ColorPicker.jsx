...
const ColorPicker = ({selectedColor, onChange}) => {
  ...
  return (
    <div className='relative'>
        <button onClick={()=> setIsOpen(!isOpen)} className='flex items-center gap-1 text-sm text-orange-600 bg-linear-to-br from-yellow-50 to-yellow-100 ring-yellow-300 hover:ring transition-all px-3 py-2 rounded-lg'>
